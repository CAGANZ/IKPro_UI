...
export const DataProvider = ({ children }) => {
  ...
  const addAvansTalep = async (newAvansTalep) => {
    ...
    try {
      ...
      if (response.status === 200) {
        showToast("Avans Talebi Oluşturuldu!");
      }
    } catch (error) {
      showToast("Avans Talep eklenemedi!", "error");
    }
  };
  ...
  const addSirket = async (newSirket) => {
    ...
    try {
      ...
      showToast("Şirket eklenemedi!", "error");
    }
  };
  ...
  const addSirketYonetici = async (newSirketYonetici) => {
    ...
    try {
      ...
      if (response.status === 200) {
        showToast("Şirket Yöneticisi Eklendi!");
      }
    } catch (error) {
      showToast("Şirket Yöneticisi Eklenemedi!", "error");
    }
  };
  ...
  const addPaket = async (newPaket) => {
    ...
    try {
      ...
      if (response.status === 200) {
        showToast("Paket Eklendi!");
        navigate("/YoneticiAnasayfa");
      }
    } catch (error) {
      showToast("Paket Eklenemedi!", "error");
    }
  };
  ...
  const updateAdmin = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
        showToast("Admin Güncellendi!");
      }
    } catch (error) {
      showToast("Admin Güncellenemedi!", "error");
    }
  };
  ...
  const updateSirketYonetici = async (e) => {
    ...
    try {
      ...
      if (response.status === 200) {
        showToast("Şirket Yöneticisi Güncellendi!");
      }
    } catch (error) {
      showToast("Şirket Yöneticisi Güncellenemedi!", "error");
    }
  };
  ...
  const addPersonel = async (newPersonel) => {
    ...
    try {
      ...
      showToast("Personel Eklenilmedi!", "error");
    }
  };
